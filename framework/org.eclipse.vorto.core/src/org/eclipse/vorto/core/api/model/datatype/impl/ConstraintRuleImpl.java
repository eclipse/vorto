 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.vorto.core.api.model.datatype.impl.ConstraintRuleImpl#getConstraints <em>Constraints</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConstraintRuleImpl extends MinimalEObjectImpl.Container implements ConstraintRule {
	...
	protected EClass eStaticClass() {
		return DatatypePackage.Literals.CONSTRAINT_RULE;
	}
	...
	public EList<Constraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentEList<Constraint>(Constraint.class, this, DatatypePackage.CONSTRAINT_RULE__CONSTRAINTS);
		}
		return constraints;
	}
