...
public class DefaultMessageDisplay implements IMessageDisplay {
	...
	public void displayError(final String msg) {
		this.showStatus(new Status(IStatus.ERROR, PLUGIN_ID, msg));
	}
	...
	public void displaySuccess(final String msg) {
		this.showStatus(new Status(IStatus.OK, PLUGIN_ID, msg));
	...
	public void displayWarning(final String msg) {
		this.showStatus(new Status(IStatus.WARNING, PLUGIN_ID, msg));
	...
	public void display(final String msg) {
		this.showStatus(new Status(IStatus.INFO, PLUGIN_ID, msg));
