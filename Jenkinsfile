      ...
      stage("Build"){
        steps{
            ...
            withMaven(
				...
				withCredentials([string(credentialsId: 'aws-elastic-search-token', variable: 'PROXY_USER', variable: 'PROXY_PWD', variable: 'PROXY_HOST', variable: 'PROXY_PORT', variable: 'AWS_ACCESS_TOKEN', variable: 'AWS_SECRET_KEY')]) {
