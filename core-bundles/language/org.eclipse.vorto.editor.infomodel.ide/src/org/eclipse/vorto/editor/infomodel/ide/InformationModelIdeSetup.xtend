 ...
 */
class InformationModelIdeSetup extends InformationModelStandaloneSetup {

	override createInjector() {
		Guice.createInjector(Modules2.mixin(new InformationModelRuntimeModule, new InformationModelIdeModule))
	}
