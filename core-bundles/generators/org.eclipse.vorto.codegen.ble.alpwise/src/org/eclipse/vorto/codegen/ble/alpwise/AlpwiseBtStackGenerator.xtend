...
import static org.eclipse.vorto.codegen.ble.templates.BleGattTemplate.*
...
class AlpwiseBtStackGenerator implements IVortoCodeGenerator {
	...
	override GeneratorInfo getInfo() {
		return GeneratorInfo.basicInfo("Alpwise BLE Stack",
			"Generates a Vorto interface for the Alpwise Bluetooth LE Stack",
			"Vorto Community");
		}
