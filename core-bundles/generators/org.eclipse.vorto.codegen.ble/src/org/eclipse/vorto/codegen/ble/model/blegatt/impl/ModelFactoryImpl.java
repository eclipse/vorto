...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ModelPackage.DEVICE_INFO: return createDeviceInfo();
			case ModelPackage.SERVICE: return createService();
			case ModelPackage.CHARACTERISTIC: return createCharacteristic();
			case ModelPackage.CHARACTERISTIC_PROPERTY: return createCharacteristicProperty();
			default:
