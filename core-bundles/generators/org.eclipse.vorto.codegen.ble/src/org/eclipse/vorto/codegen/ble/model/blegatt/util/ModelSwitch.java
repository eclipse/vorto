	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModelPackage.DEVICE: {
				...
				if (result == null) result = caseModel(device);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.DEVICE_INFO: {
			...
			case ModelPackage.SERVICE: {
				...
				if (result == null) result = caseModel(service);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.CHARACTERISTIC: {
				Characteristic characteristic = (Characteristic)theEObject;
				T result = caseCharacteristic(characteristic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.CHARACTERISTIC_PROPERTY: {
