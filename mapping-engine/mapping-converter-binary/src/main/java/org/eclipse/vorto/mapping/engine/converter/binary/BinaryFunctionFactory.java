...
public class BinaryFunctionFactory {
	...
	private static final IFunction FUNC_CONVERSION = new ClassFunction("vorto_conversion1", Conversion.class);
	private static final IFunction FUNC_CONVERSION2 = new ClassFunction("vorto_conversion2", DatatypeConverter.class);
	...
	@Deprecated
	private static final IFunction FUNC_CONVERSION_OLD = new ClassFunction("conversion", Conversion.class);
	@Deprecated
	private static final IFunction FUNC_CONVERSION2_OLD = new ClassFunction("binaryString", DatatypeConverter.class);
	@Deprecated
	...
	public static IFunction[] createFunctions() {
		return Arrays.asList(FUNC_CONVERSION,FUNC_CONVERSION2,FUNC_BASE64,FUNC_ENDIAN,FUNC_CONVERSION_OLD,FUNC_CONVERSION2_OLD,FUNC_BASE64_OLD,FUNC_ENDIAN_OLD).toArray(new IFunction[8]);
	}
}
