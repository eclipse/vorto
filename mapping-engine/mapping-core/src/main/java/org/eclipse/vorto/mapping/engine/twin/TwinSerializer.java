...
public class TwinSerializer {
	 ...
	 * @return ditto protocol containing vorto data, that can be sent to Ditto to update all features in one request
	 */
	public static Map<String, Object> toDittoProtocol(InfomodelValue infomodelData, String dittoNamespace, String dittoIdSuffix) {
	...
	/**
	 * Creates Ditto protocol payload for modifying the feature properties with the Vorto function block data
	 ...
	 */
	public static Map<String, Object> toDittoProtocol(FunctionblockValue functionblockData, String featureId, String dittoNamespace, String dittoIdSuffix) {
		Map<String, Object> dittoPayload = new HashMap<String, Object>();
		dittoPayload.put("topic", dittoNamespace+"/"+dittoIdSuffix+"/things/twin/commands/modify");
		dittoPayload.put("headers", createHeader());
