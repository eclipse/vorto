...
public final class ValidationTaskFactory {
	...
	public static ICodeGeneratorTask<FunctionBlock> getPropertiesValidationTask(String fileExt, String path) {
	...
	public static ICodeGeneratorTask<Fault> getPropertiesFaultValidationTask(String fileExt, String path) {
	...
	public static ICodeGeneratorTask<Property> getPropertiesSinglePropertyValidationTask(String fileExt, String path) {
	...
	public static ICodeGeneratorTask<Operation> getOperationParametersValidationTask(String fileExt, String path) {
		return new OperationParametersValidationGeneratorTask(fileExt, path, ValidationTemplates.operationPayloadValidationTemplate);
	}
	
	public static ICodeGeneratorTask<Operation> getOperationReturnTypeValidationTask(String fileExt, String path) {
		return new OperationReturnTypeValidationGeneratorTask(fileExt, path, ValidationTemplates.operationResponseValidationTemplate);
	}
