...
We will use our [RaspberryPi Information Model](https://vorto.eclipseprojects.io/#/details/org.eclipse.vorto.tutorials:RaspberryPi:1.0.0) again.
...
**1.** On the Vorto Repository page of your Information Model (we will use the [RaspberryPi Information Model](https://vorto.eclipseprojects.io/#/details/org.eclipse.vorto.tutorials:RaspberryPi:1.0.0)), click on the `Bosch IoT Suite` generator. This will trigger a pop up to appear with the available generators.     
...
The `cpuTemperature` in our [Raspbi IM](https://vorto.eclipseprojects.io/#/details/org.eclipse.vorto.tutorials:RaspberryPi:1.0.0) is a [Temperature Function Block](https://vorto.eclipseprojects.io/#/details/org.eclipse.vorto:Temperature:1.0.0). 
```js
...
```
As we can see, it has a `value` which is a [SensorValue Data Type](https://vorto.eclipseprojects.io/#/details/org.eclipse.vorto.types:SensorValue:1.0.0). This DT has one mandatory value, `currentMeasured` and two optional ones.   
