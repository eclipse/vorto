# Describing a device as Information Model
...
As Vorto is all about using generic classes and reducing integration effort, we will make use of the already existing description of a [humidity sensor](https://vorto.eclipseprojects.io/#/details/org.eclipse.vorto:Humidity:1.0.0?s=humid) you can conveniently find in the [Vorto Repository](https://vorto.eclipseprojects.io/). 
