# Connecting the XDK with Bluetooth to the Bosch IoT Suite
...
We will walk you through the steps of developing a small "Hello World" IoT app that reads a XDK's surrounding temperature from a Raspberry Pi, running Eclipse Kura, which then transmits the measured temperature to the Bosch IoT Suite where it can be visualized in a web application and voice-controlled via Amazon Alexa Service. 
  ...
  <td colspan="1">
    ...
    <ol>
      ...
      <img src="./images/connect_xdk_kura/step2_8.png" width="70%"/></li>
	   ...
	   <li>
	    <p>Repeat the steps to create another permission ACL for the xdk web application, that we are going to develop in the next chapter.</p>
    <p>Call the ID of the app, e.g. <em>&lt;solutionID&gt;:xdkapp </em>and grant the read and write permissions. Click <b>Save</b> to confirm.</p>
    <p>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <p>
          <img src="./images/connect_xdk_kura/step3_2.png" width="50%"/>
        </p>
