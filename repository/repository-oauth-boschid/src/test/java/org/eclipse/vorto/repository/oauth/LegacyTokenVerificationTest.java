...
public class LegacyTokenVerificationTest extends AbstractVerifierTest {
  ...
  private BoschIoTSuiteOAuthProviderKeycloak getVerifier() {
    ...
    return new BoschIoTSuiteOAuthProviderKeycloak(publicKey(), userAccountService, userNamespaceRoleService);
  }
