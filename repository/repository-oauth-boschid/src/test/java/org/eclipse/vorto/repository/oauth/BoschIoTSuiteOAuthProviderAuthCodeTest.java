...
public class BoschIoTSuiteOAuthProviderAuthCodeTest extends AbstractVerifierTest {
    ...
    private static final String TOKEN_WITHOUT_VORTO_SCOPE = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InB1YmxpYzoxYjI2ZDEwYi1iMTZjLTQ4MDQtYmM4MC1jMWUzOWJhNTZlMjAifQ..Y3bhWNzLJAQq_bsCK9HqiSYSZjzAXTBtmrGbaePprY-VaArQRkOa4_o_2q6fMFzma3mMk0294YtvQFYMMzQ_oMJYtcS5xdq4D_8tp9R8KAtcKWnousY1-rIOGvtTVW4CjMtIoMMjc-MALa7nri32VlqlqCsewUJo6bD_CzJt71fD1IjIFwxMRf544ArXGPhBWnRkCNjLqpzkzDCHNxeHAub0Da6ZYC_9kk9S-DV-v66RXELqbGSzaNcyWVIZquMaoj7zskeIwURMAZXa9VXlMzefmKZbjEN7FZKDd2Gld9IrM9F2gYJ10WqzxcoY14QgpRBoOi-6cX0SEnNhhtLMMQ";
    ...
    @Test
    public void authenticateMissingScopeTest() {
        when(userAccountService.getUser(any())).thenReturn(new User());
        Authentication authentication = sut.authenticate(null, TOKEN_WITHOUT_VORTO_SCOPE);
        assertNull(authentication);
    }
