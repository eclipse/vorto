...
public class ModelResolveController {
	...
	public ModelId resolve(@ApiParam(value = "Generator service key, e.g. LWM2M", required = true) @PathVariable("serviceKey") final String serviceKey, 
						   @ApiParam(value = "Platform specific stereotype name defined in mappings", required = true) @PathVariable("stereoType") final String stereoType,
						   @ApiParam(value = "Platform specific attributeId defined in mappings", required = true) @PathVariable("attributeId") final String attributeId,
						   @ApiParam(value = "Platform specific attributeValue defined in mappings", required = true) @PathVariable("attributeValue") final String attributeValue) throws Exception{
	
		
		ModelId resolvedId = resolver.resolve(new ResolveQuery(serviceKey,attributeId, attributeValue,stereoType));
