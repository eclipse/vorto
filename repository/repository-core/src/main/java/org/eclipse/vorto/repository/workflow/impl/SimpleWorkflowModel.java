...
public class SimpleWorkflowModel implements IWorkflowModel {
	...
	public static final DefaultAction ACTION_RELEASE = new DefaultAction("Release","Releasing a model will trigger a review process done by the model reviewers of the according repository. Once approved, your model will be released.");
