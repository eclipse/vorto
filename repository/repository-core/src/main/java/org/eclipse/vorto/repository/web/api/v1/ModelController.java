...
public class ModelController extends AbstractRepositoryController {
  ...
  public ModelInfo getModelInfo(
    ...
    return ModelDtoFactory.createDto(tenantId, resource);
  }
  ...
  public void downloadModelById(
      ...
      @ApiParam(value = "The modelId of vorto model, e.g. com.mycompany:Car:1.0.0",
          required = true) final @PathVariable String modelId,
      @ApiParam(value = "Set true if dependencies shall be included", required = false,
          allowableValues = "FALSE,TRUE", defaultValue = "FALSE") final @RequestParam(
              value = "includeDependencies", required = false) boolean includeDependencies,
