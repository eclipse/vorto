 ...
 */
@Api(value = "/models")
@RestController("modelRepositoryController2")
@RequestMapping(value = "/api/v1/models")
public class ModelController2 extends AbstractRepositoryController {

  @Autowired
  private ITenantService tenantService;

  private static Logger logger = Logger.getLogger(ModelController2.class);
