...
public class ModelAuthorUnhashUpgradeTaskTest {
	...
	public void initMocks() {
		Mockito.when(modelRepository.search("author:" + userContext.getHashedUsername())).thenReturn(models);
		Mockito.when(modelRepository.search(AdditionalMatchers.not(Matchers.eq("author:" + userContext.getHashedUsername()))))
