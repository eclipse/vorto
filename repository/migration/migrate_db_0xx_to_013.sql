...
UPDATE USER SET AUTHENTICATION_PROVIDER_ID = 'BOSCH-ID' WHERE (USERNAME LIKE 'S-%-%-%-%-%-%-%' AND CHAR_LENGTH(USERNAME) = 47);
UPDATE USER SET AUTHENTICATION_PROVIDER_ID = 'GITHUB' WHERE (USERNAME NOT LIKE 'S-%-%-%-%-%-%-%' OR CHAR_LENGTH(USERNAME) <> 47);
