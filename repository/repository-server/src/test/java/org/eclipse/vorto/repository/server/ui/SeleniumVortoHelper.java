...
public class SeleniumVortoHelper {
  ...
  public void openManageTab() {
    ...
    webDriver
        .findElementByXPath("//div[@id='searchResult']/div[not(contains(@class,'ng-hide'))]");
  ...
  public void addUserToNamespace(String userToAdd, String namespace, String... roles) {
    ...
    WebElement manageUsersLink = this.webDriver.findElementByXPath(
        "//div[@class='ng-binding' and contains(.,'" + namespace
            + "')]/../../td/a[@ng-click='manageUsers(namespace)']");
    manageUsersLink.click();
    this.webDriver.findElementByXPath("//button[@ng-click='createOrUpdateUser(newUser())']")
        .click();
  ...
  /**
   * Navigates to the UI page for model details of the given model ID.
   *
   * @param modelId
   */
