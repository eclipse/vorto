...
public class GdprUpgradeTaskTest extends AbstractIntegrationTest {
	...
	@Mock
	protected CommentRepository commentRepository = Mockito.mock(CommentRepository.class);
	...
	public void beforeEach() throws Exception {
		...
		commentService.setModelRepository(this.modelRepository);
		commentService.setCommentRepository(commentRepository);
		
		task = new GdprUpgradeTask(this.modelRepository,commentService);
