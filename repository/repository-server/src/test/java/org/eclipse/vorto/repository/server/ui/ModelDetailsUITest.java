...
public class ModelDetailsUITest extends AbstractUITest {
    ...
    @Test public void testSaveModelSuccessfulNotification() {
        createModel().succeed();
    ...
    @Test public void testSaveModelErrorNotification() {
        createModel().succeed();
        RemoteWebDriver driver = seleniumVortoHelper.getRemoteWebDriver();
        // going full screen
        driver.manage().window().fullscreen();
    ...
    @Test public void testCreateModelWithBadSubNS() {
    ...
    @Test public void testCreateModelWithCapitalizedSubNS() {
        CreateModelParams params =
            new CreateModelParams().withName(CreateModelParams.defaults().getName())
     ...
     */
    @Test public void testLoadModelWithCapitalizedNS() {
        createModel().succeed();
     ...
     */
    @Test public void testRenameModelWithBadSubNS() {
        createModel().succeed();
        ModelId id = new ModelId(CreateModelParams.defaults().getName(),
     ...
     */
    @Test public void testRenameModelWithCapitalizedSubNS() {
        createModel().succeed();
        ModelId id = new ModelId(CreateModelParams.defaults().getName(),
            CreateModelParams.defaults().getNamespace(), "1.0.0");
        RenameModelParams params = new RenameModelParams()
