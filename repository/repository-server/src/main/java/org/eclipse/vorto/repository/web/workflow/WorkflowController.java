...
public class WorkflowController {
    ...
    public WorkflowResponse executeAction(@ApiParam(value = "modelId", required = true) @PathVariable String modelId,
    	...
    	try {
			ModelInfo model = workflowService.doAction(ModelId.fromPrettyFormat(modelId), UserContext.user(SecurityContextHolder.getContext().getAuthentication().getName()), actionName);
