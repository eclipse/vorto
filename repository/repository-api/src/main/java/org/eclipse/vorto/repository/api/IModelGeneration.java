...
/**
 * Lets you generate platform specific code for Information Models that were found 
 * either via {@link IModelRepository} or resolved via {@link IModelResolver}
 *
 */
public interface IModelGeneration {

	/**
	 * Gets all available generators keys of generators that are currently registered in the repository.
	 ...
	 */
	CompletableFuture<GeneratedOutput> generate(ModelId modelId, String generatorKey, Map<String,String> invocationParams);
}
