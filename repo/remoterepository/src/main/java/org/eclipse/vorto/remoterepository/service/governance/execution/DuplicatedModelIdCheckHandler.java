...
import org.eclipse.vorto.remoterepository.service.governance.exception.DuplicatedModelIDException;
...
@Component 
@Order(value=1)
public class DuplicatedModelIdCheckHandler implements IModelGovernanceHandler {
	...
	public void handleModel(ModelContent modelContent, ModelAuthor author) {
		...
		if(modelDAO.exists(mid)){
			throw new DuplicatedModelIDException();
		}
