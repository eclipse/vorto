...
import org.eclipse.vorto.codegen.service.bosch.fbbasedriver.tasks.template.BlueprintConfigTemplate;
...
public class BlueprintConfigGeneratorTask extends
	...
	public String getPath(FunctionblockModel model) {
		return new BaseDriverUtil(model).getBaseResourcesDirectory()+"OSGI-INF/blueprint";
	}
