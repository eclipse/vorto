...
import org.eclipse.vorto.codegen.service.bosch.fbbasedriver.tasks.template.basedriver.BaseDriverTemplate;
import org.eclipse.vorto.core.api.model.functionblock.FunctionblockModel;

public class BaseDriverGeneratorTask extends
		AbstractTemplateGeneratorTask<FunctionblockModel> {

	@Override
	public String getFileName(FunctionblockModel model) {
		model.getFunctionblock().getEvents();
		return "DummyBaseDriver.java";
	}
