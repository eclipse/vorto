...
import org.eclipse.vorto.codegen.service.bosch.fbbasedriver.tasks.template.device.DummyDeviceTemplate;
import org.eclipse.vorto.core.api.model.functionblock.FunctionblockModel;

public class DummyDeviceGeneratorTask extends
		AbstractTemplateGeneratorTask<FunctionblockModel> {

	@Override
	public String getFileName(FunctionblockModel model) {
		return "Dummy" + model.getName() + "Device.java";
	}
	...
	public ITemplate<FunctionblockModel> getTemplate() {
		return new DummyDeviceTemplate();
	}
