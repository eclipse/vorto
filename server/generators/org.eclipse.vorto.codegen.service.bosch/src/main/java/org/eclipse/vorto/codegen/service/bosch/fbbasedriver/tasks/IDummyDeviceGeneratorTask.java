...
import org.eclipse.vorto.codegen.service.bosch.fbbasedriver.tasks.template.device.IDummyDeviceTemplate;
...
public class IDummyDeviceGeneratorTask extends
	...
	public String getPath(FunctionblockModel model) {
		return new BaseDriverUtil(model).getDeviceApiPath();
	}
