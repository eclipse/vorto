...
public interface IGeneratorService {
	 ...
	 * Unregistered generators can no longer be used to generate any code from information models.
	 * @param serviceKey
	 */
	 ...
	 * @return
	 */
	GeneratorServiceInfo getGeneratorServiceInfo(String serviceKey);
	 ...
	 * @return
	 */
	Collection<GeneratorServiceInfo> getMostlyUsedGenerators(int top);
