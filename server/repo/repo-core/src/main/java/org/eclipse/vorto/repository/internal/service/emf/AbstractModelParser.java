...
public abstract class AbstractModelParser implements IModelParser {
	...
	@Override
	public ModelResource parse(InputStream is,Session session) {
		return new ModelEMFResource(doParse(is,session));
	}
	
	protected abstract Model doParse(InputStream is,Session session);
