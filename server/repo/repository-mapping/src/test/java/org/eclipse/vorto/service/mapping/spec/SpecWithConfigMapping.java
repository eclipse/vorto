...
public class SpecWithConfigMapping extends AbstractTestSpec {
	...
	private FunctionblockModel createVoltageFb() {
		...
		voltageModel
				.setConfigurationProperties(Arrays.asList(new ModelProperty[] { sensorValueProperty, sensorUnitsProperty }));
