...
public class FunctionBlockEditorController extends AbstractEditorController {
	...
	public String linkReferenceToResource(String resoruceId, ModelId modelId, ResourceSet resourceSet) {
		String content = functionBlockEditorServiceImpl.linkReferenceToResource(resoruceId, modelId, resourceSet);
		return content;
	}

	@Override
	public List<ModelInfo> search(String expression) {
		return functionBlockEditorServiceImpl.searchModelByExpression(expression);
	}

	@Override
	public String linkReferenceToResource(String targetResourceId, String referenceResourceId,
			ResourceSet resourceSet) {
		String content = functionBlockEditorServiceImpl.linkReferenceToResource(targetResourceId, referenceResourceId,
				resourceSet);
		return content;
	}
}
