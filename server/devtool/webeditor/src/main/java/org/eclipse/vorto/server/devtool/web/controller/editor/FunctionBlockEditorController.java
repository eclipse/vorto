...
public class FunctionBlockEditorController extends AbstractEditorController {
	...
	public LinkReferenceResponse linkReferenceToResource(String resoruceId, ModelId modelId, ResourceSet resourceSet) {
		return functionBlockEditorServiceImpl.linkReferenceToResource(resoruceId, modelId, resourceSet);
	}
	...
	public LinkReferenceResponse linkReferenceToResource(String targetResourceId, String referenceResourceId,
		...
		return functionBlockEditorServiceImpl.linkReferenceToResource(targetResourceId, referenceResourceId,
				resourceSet);
