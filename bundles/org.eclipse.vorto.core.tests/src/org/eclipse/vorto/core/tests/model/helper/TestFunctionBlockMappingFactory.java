...
public class TestFunctionBlockMappingFactory {
	...
	public static FunctionBlockMappingModel createFunctionBlockMappingModel() {
		FunctionBlockMappingModel mappingModel = MappingFactory.eINSTANCE.createFunctionBlockMappingModel();
