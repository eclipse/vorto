...
import org.eclipse.vorto.codegen.internal.mapping.EntityMappingRuleWrapper;
...
public class EntityMappingRuleWrapperTest {
	@Test
	public void testGetRule() {
		EntityMappingRule entityMappingRule = TestEntityMappingFactory.createEntityAttributeToStereoTypeMappingRule();
		IMappingRule mappingRule = new EntityMappingRuleWrapper(entityMappingRule);

		EObject modelMappingRule = mappingRule.getRule();
		assertEquals(modelMappingRule, entityMappingRule);
