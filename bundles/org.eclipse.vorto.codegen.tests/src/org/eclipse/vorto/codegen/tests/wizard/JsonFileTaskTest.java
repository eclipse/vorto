...
import org.eclipse.vorto.codegen.tests.wizard.util.JsonTestTemplate;
import org.junit.Before;
import org.junit.Test;

public class JsonFileTaskTest {

	private static final String GENERATOR_NAME = "JsonGenerator";
	private static final String PACKAGE_NAME = "testPackageName";
	private static final String PACKAGE = "projectPackage";
	private static final String PATH = "/src/" + PACKAGE;
	private static final String FILE_NAME = "JsonGenerator.xtend";
	private static final Object EXPECTED = new JsonTestTemplate().print();
	private JsonFileTask task = null;

	@Before
	public void init() {
		task = new JsonFileTask();
	}

	@Test
	public void testFileName() {
		String fileName = task.getFileName(new ExampleProjectContext(
				null, null, null));
	...
	public void testPath() {
		String path = task.getPath(new ExampleProjectContext(null, PACKAGE,
				null));
