 ...
 *
 */
public class FaultRulesFilter extends AbstractFunctionBlockChildRulesFilter {
	public boolean isRuleContainsContainsModelElement(FunctionBlockMappingRule rule,
		...
		Property functionBlockProperty = ((FaultElement) sourceElement.getFunctionBlockElement()).getTypeRef().getProperty();
