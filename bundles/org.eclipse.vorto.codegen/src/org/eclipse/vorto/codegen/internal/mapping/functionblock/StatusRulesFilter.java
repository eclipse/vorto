 ...
 *
 */
public class StatusRulesFilter extends AbstractFunctionBlockChildRulesFilter {
	public boolean isRuleContainsContainsModelElement(FunctionBlockMappingRule rule,
		...
		Property functionBlockProperty = ((StatusElement) sourceElement.getFunctionBlockElement()).getTypeRef().getProperty();
