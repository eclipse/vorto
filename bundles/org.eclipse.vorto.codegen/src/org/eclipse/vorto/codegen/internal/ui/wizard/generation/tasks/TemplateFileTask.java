...
import org.eclipse.vorto.codegen.internal.ui.wizard.generation.templates.TemplateFileTemplate;

public class TemplateFileTask extends
		AbstractTemplateGeneratorTask<IGeneratorProjectContext> {

	@Override
	public String getFileName(final IGeneratorProjectContext pmd) {
		return pmd.getGeneratorName() + ".xtend";
	}

	@Override
	public String getPath(final IGeneratorProjectContext pmd) {
		return "/src/" + pmd.getPackageFolders();
	}

	@Override
	public ITemplate<IGeneratorProjectContext> getTemplate() {
		return new TemplateFileTemplate();
	}
}
