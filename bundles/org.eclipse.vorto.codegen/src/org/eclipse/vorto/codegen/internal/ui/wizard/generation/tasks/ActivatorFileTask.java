...
import org.eclipse.vorto.codegen.internal.ui.wizard.generation.templates.ActivatorFileTemplate;

public class ActivatorFileTask extends
	...
	public ITemplate<IGeneratorProjectContext> getTemplate() {
		return new ActivatorFileTemplate();
	}
