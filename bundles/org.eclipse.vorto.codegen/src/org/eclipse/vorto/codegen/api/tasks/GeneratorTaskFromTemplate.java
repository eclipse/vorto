...
public class GeneratorTaskFromTemplate<Context> extends
		AbstractTemplateGeneratorTask<Context> implements
		ICodeGeneratorTask<Context> {

	private IFileTemplate<Context> fileTemplate;

	public GeneratorTaskFromTemplate(IFileTemplate<Context> template) {
