...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Functionblock Model Attribute</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.vorto.core.api.model.mapping.MappingPackage#getFunctionblockModelAttribute()
 * @model
 * @generated
 */
public enum FunctionblockModelAttribute implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Functionblock Model Attribute</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final FunctionblockModelAttribute[] VALUES_ARRAY =
		new FunctionblockModelAttribute[] {
			NAME,
			NAMESPACE,
			VERSION,
			DISPLAYNAME,
	...
	/**
	 * A public read-only list of all the '<em><b>Functionblock Model Attribute</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<FunctionblockModelAttribute> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Functionblock Model Attribute</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static FunctionblockModelAttribute get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FunctionblockModelAttribute result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Functionblock Model Attribute</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static FunctionblockModelAttribute getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FunctionblockModelAttribute result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Functionblock Model Attribute</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static FunctionblockModelAttribute get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private FunctionblockModelAttribute(int value, String name, String literal) {
		this.value = value;
		this.name = name;
