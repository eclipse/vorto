...
public class PresenceImpl extends MinimalEObjectImpl.Container implements Presence {
	...
	public void setMandatory(boolean newMandatory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatatypePackage.PRESENCE__MANDATORY, oldMandatory, mandatory));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DatatypePackage.PRESENCE__MANDATORY:
				return isMandatory();
		}
