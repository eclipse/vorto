 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.vorto.core.api.model.mapping.impl.EnumMappingRuleImpl#getSources <em>Sources</em>}</li>
...
public class EnumMappingRuleImpl extends MinimalEObjectImpl.Container implements EnumMappingRule {
	 ...
	 * @ordered
	 */
	protected EList<EnumSource> sources;
	 ...
	 * @generated
	 */
	public EList<EnumSource> getSources() {
		if (sources == null) {
			sources = new EObjectContainmentEList<EnumSource>(EnumSource.class, this, MappingPackage.ENUM_MAPPING_RULE__SOURCES);
		}
		return sources;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MappingPackage.ENUM_MAPPING_RULE__SOURCES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case MappingPackage.ENUM_MAPPING_RULE__SOURCES:
				getSources().clear();
				getSources().addAll((Collection<? extends EnumSource>)newValue);
				return;
			case MappingPackage.ENUM_MAPPING_RULE__TARGET:
