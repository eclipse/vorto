...
public class ModelId implements Comparable<ModelId> {
	...
	public ModelId(ModelType modelType, String name, String namespace,
			String version) {
	...
	public ModelReference asModelReference() {
		ModelReference modelReference = ModelFactory.eINSTANCE
	...
	public String toString() {
		return "ModelId [modelType=" + modelType + ", name=" + name
