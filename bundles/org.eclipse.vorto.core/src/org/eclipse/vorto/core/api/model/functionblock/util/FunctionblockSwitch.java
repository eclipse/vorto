	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FunctionblockPackage.FUNCTIONBLOCK_MODEL: {
				...
				if (result == null) result = caseModel(functionblockModel);
			...
			case FunctionblockPackage.CONFIGURATION: {
				Configuration configuration = (Configuration)theEObject;
				T result = caseConfiguration(configuration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FunctionblockPackage.STATUS: {
				Status status = (Status)theEObject;
				T result = caseStatus(status);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FunctionblockPackage.FAULT: {
			...
			case FunctionblockPackage.PRIMITIVE_PARAM: {
				...
				if (result == null) result = caseParam(primitiveParam);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FunctionblockPackage.REF_PARAM: {
			...
			case FunctionblockPackage.PARAM: {
