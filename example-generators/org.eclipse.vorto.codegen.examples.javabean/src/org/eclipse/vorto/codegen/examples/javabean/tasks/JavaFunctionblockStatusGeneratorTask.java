...
import org.eclipse.vorto.codegen.examples.javabean.tasks.template.FunctionblockStatusTemplate;
...
public class JavaFunctionblockStatusGeneratorTask extends AbstractTemplateGeneratorTask<FunctionblockModel> {
	...
	public JavaFunctionblockStatusGeneratorTask(String javaFileExtension, 
			String targetPath, 
			String classPackage,
	...
	public ITemplate<FunctionblockModel> getTemplate() {
		return new FunctionblockStatusTemplate(imports,implSuffix, classPackage);
	}
}
