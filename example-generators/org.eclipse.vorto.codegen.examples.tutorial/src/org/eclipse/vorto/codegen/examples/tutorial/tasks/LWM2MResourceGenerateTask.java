...
public class LWM2MResourceGenerateTask extends AbstractMappingAwareGeneratorTask{

	/**
	 * @param mapping
	 */
	public LWM2MResourceGenerateTask(IMapping mapping) {
		super(mapping);
	}
	...
	public String getFileName(InformationModel ctx) {
		return "LWM2MResourceGenerateTask_generated.xml";
	}
	...
	public ITemplate<InformationModel> getTemplate() {
		return new LWM2MResourceTemplate(this.getMapping());
	}
