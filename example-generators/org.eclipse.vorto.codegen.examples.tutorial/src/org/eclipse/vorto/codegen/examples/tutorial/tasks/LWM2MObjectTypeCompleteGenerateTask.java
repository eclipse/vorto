...
public class LWM2MObjectTypeCompleteGenerateTask  extends AbstractMappingAwareGeneratorTask{

	/**
	 * @param mapping
	 */
	public LWM2MObjectTypeCompleteGenerateTask(IMapping mapping) {
		super(mapping);
	}
	...
	public String getFileName(InformationModel ctx) {
		return "LWM2MObjectTypeCompleteGenerateTask_generated.xml";
	}
	...
	public ITemplate<InformationModel> getTemplate() {
		return new LWM2MObjectTypeCompleteTemplate(this.getMapping());
	}
