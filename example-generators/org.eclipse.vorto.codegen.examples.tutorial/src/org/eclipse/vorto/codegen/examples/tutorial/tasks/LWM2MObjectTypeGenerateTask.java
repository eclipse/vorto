...
public class LWM2MObjectTypeGenerateTask  extends AbstractMappingAwareGeneratorTask{

	/**
	 * @param mapping
	 */
	public LWM2MObjectTypeGenerateTask(IMapping mapping) {
		super(mapping);
	}
	...
	public String getFileName(InformationModel ctx) {
		return "LWM2MObjectTypeGenerateTask_generated.xml";
	}
	...
	public ITemplate<InformationModel> getTemplate() {
		return new LWM2MObjectTypeTemplate(this.getMapping());
	}
