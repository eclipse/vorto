...
public class LWM2MResourceEntityGenerateTask extends AbstractMappingAwareGeneratorTask{

	/**
	 * @param mapping
	 */
	public LWM2MResourceEntityGenerateTask(IMapping mapping) {
		super(mapping);
	}
	...
	public String getFileName(InformationModel ctx) {
		return "LWM2MResourceEntityGenerateTask_generated.xml";
	}
	...
	public ITemplate<InformationModel> getTemplate() {
		return new LWM2MResourceEntityTemplate(this.getMapping());
	}
