...
class LWM2MResourceEnumTemplate implements ITemplate<InformationModel> {
...
'''
	...
	def String printContentForStereoTypeTarget(StereoTypeTarget resourceStereoType) {
		return '''
	<Type>
		<Name>«getAttributeValueSafely(resourceStereoType, "Name")»</Name>
		<Units>«getAttributeValueSafely(resourceStereoType, "Label")»</Units>
	</Type>		
		''';
	}
