...
public class AbstractDummyDeviceGeneratorTaskTest {
	AbstractDummyDeviceGeneratorTask generatorTask = new AbstractDummyDeviceGeneratorTask();
	...
	public void testGetFileName() {
		String expectedFileName = "AbstractDummyDevice.java";
	...
	public void testGetTemplate() {
		assertTrue(generatorTask.getTemplate() instanceof AbstractDummyDeviceTemplate);
	}
}
