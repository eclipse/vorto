...
class JavaFBOperationReturnPrimitiveTypeWrapperTemplate implements ITemplate<Operation>{
		...
		'''
			...
			*/
			...
			public class «className.toFirstUpper» {
				...
				private «CoAPUtils.getReturnTypeAsString(op)» value;

				«IF op.returnType != null»
				public «CoAPUtils.getReturnTypeAsString(op)» getValue() {
					return value;
				}
				
				public void setValue(«CoAPUtils.getReturnTypeAsString(op)» value) {
					this.value = value; 
				}
