		...
		'''
			{
				...
				"description": "Generated by Vorto Bosch IoT Things Generator from model [«invocationContext.configurationProperties.get("modelId")»] for Operation [«operation.name»].",
				"type": "object",
				"properties": {
